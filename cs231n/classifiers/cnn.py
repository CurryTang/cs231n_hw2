...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        x, cache2 = affine_relu_forward(conv, W2, b2)
        ...
        dhidden, dW3, db3 = affine_backward(dscores, cache3)
        dconv_out, dW2, db2 = affine_relu_backward(dhidden, cache2)
        dX, dW1, db1 = conv_relu_pool_backward(dconv_out, cache1)
        dW2 += self.reg * W2
        dW3 += self.reg * W3
